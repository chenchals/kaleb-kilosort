...
ops.nSpikesPerBatch     = 100; % emouse has 4000, is this spike rate?
...
ops.root                = resultPath; % 'openEphys' only: where raw files are		
% define the channel map as a filename (string) or simply an array
ops.Nchan               = 32;
% ops.chanMap             = [];%fullfile(fpath, 'chanMap.mat'); % make this file using createChannelMapFile.m		
ops.chanMap             = 'tdtChanMap';%1:ops.Nchan; % treated as linear probe if unavailable chanMap file		
...
ops.Th               = [10 20 20];    % threshold for detecting spikes on template-filtered data ([6 12 12])		
