...
simulationPath = '~/Projects/SpikeSorting/eMouse2';
configFilePath = '~/Projects/KiloSort/eMouse/';
fpath =simulationPath; %   = '/Users/subravcr/GitHub/Matlab/KiloSort/eMouse/MySimulation'; % where on disk do you want the simulation? ideally and SSD...
if ~exist(fpath, 'dir'); mkdir(fpath); end

% This part adds paths
addpath(genpath('~/Projects/KiloSort')) % path to kilosort folder
addpath(genpath('~/Projects/npy-matlab')) % path to npy-matlab scripts
pathToYourConfigFile = configFilePath; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
